...
"""
codejail_service documentation build configuration file.
...
VERSION = get_version('../codejail_service', '__init__.py')
...
html_context = {
    ...
    "github_repo": 'codejail-service',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/codejail-service",
...
#
# html_title = 'codejail_service v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Run codejail (sandboxed Python execution) as a service',
     'Miscellaneous'),
]
