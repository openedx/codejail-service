...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'codejail_service.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'codejail_service_sessionid'
CSRF_COOKIE_NAME = 'codejail_service_csrftoken'
LANGUAGE_COOKIE_NAME = 'codejail_service_language'
